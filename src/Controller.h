...
//		WindowConfig window;
	...
	public:
		...
		Controller(const WindowConfig& config=WindowConfig(), std::shared_ptr< NoMEM::MEMManager > mem=nullptr, std::shared_ptr< NoSFX::AudioManager > sound=nullptr, bool start=true);
